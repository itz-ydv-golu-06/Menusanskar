    ...
    .map(
      ...
      <article class="dish-card reveal reveal-delay-${(i % 3) + 1}">
        <div class="dish-media">
          ${foodPlaceholder(dish.name, dish.category)}
...
/**
 * Because there are no food photographs bundled with this static
 * project, dishes get an elegant CSS-only "plate" placeholder keyed
 * off their category icon rather than a broken <img>. Drop real
 * photos into /images and swap this for <img> whenever they're ready.
 */
...
// expose for menu.js to reuse without duplicating the icon map
